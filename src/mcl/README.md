...
本ディレクトリは、Mineclonia（Luanti 5.15.2以降）の中枢演算およびマルチスレッド環境下におけるボトルネックを高速化・安定化するために実装された、ネイティブC++ API群（計40関数）の実体仕様書である。
...
------------------------------
## 🛠️ 2. 開通APIマトリクス (40 APIs Registered)
...
------------------------------
## 🚀 3. コンパイルおよび配線手順 (Build & Binding)## C++側のビルド追加 (src/CMakeLists.txt)
