...
void bind_mainthread_CORE(lua_State *L) {
	...
	lua_pushcfunction(L, tga_encoder::l_tga_encode); lua_setfield(L, core_idx, "tga_encode");
/*
...
void bind_multithread_CORE(lua_State *L) {
	...
	lua_pushcfunction(L, util_shape::l_region_intersect_p);    lua_setfield(L, mth_idx, "native_intersect_p");
