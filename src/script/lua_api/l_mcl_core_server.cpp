...
void bind_mcl_util_mainthread(lua_State *L) {
	...
	lua_pushcfunction(L, liquids::l_liquids_find_flow_direction); lua_setfield(L, util_idx, "native_liquids_find_flow_direction");
//	lua_pushcfunction(L, liquids::l_liquids_calculate_spread);    lua_setfield(L, util_idx, "native_liquids_calculate_spread");
//	lua_pushcfunction(L, liquids::l_liquids_bulk_update_nodes);   lua_setfield(L, util_idx, "native_liquids_bulk_update_nodes");
	// liquids(flowlib)  1 poring lua to c++
	lua_pushcfunction(L, liquids::l_liquids_quick_flow_native); lua_setfield(L, util_idx, "native_liquids_quick_flow");
